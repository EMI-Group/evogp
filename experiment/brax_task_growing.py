...
FILE_NAME = os.path.join(
    args.save_path,
    f"{args.env_name}_{args.device_name}_{args.pop_size}_{args.seed}_no_delete",
)
LOG_HEADERS = [
    "generation",
    "best_fitness",
    ...
    algorithm = GeneticProgramming(
        ...
        mutation=CombinedMutation(
            [
                ...
                InsertMutation(mutation_rate=0.5, descriptor=descriptor),
            ]
        ),
        ...
        if i == 100:
            algorithm.mutation = CombinedMutation(
                [
                    ...
                    InsertMutation(mutation_rate=0.8, descriptor=descriptor),
                ]
            )
